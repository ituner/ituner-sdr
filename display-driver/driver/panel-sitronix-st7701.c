...
static void yousee_yx45011act2_sequence(struct st7701 *st7701)
{
	dev_info(st7701->panel.dev, "YX45011ACT2 source-built h400_60hz_c1_0f10_webgip init start\n");
	...
	ST7701_WRITE(st7701, 0xB0, 0xB0, 0x40, 0x14, 0x59, 0x10, 0x12,
		     0x08, 0x03, 0x09, 0x05, 0x1E, 0x05, 0x14, 0x10,
		     0x68, 0x33, 0x15);
	ST7701_WRITE(st7701, 0xB1, 0x40, 0x08, 0x53, 0x09, 0x11, 0x09,
		     0x02, 0x07, 0x09, 0x1A, 0x04, 0x12, 0x12, 0x64,
		     0x29, 0x29);

	ST7701_WRITE(st7701, 0xFF, 0x77, 0x01, 0x00, 0x00, 0x11);
	ST7701_WRITE(st7701, 0xB0, 0x6D);
	ST7701_WRITE(st7701, 0xB1, 0x1D);
	ST7701_WRITE(st7701, 0xB2, 0x87);
	ST7701_WRITE(st7701, 0xB3, 0x80);
	ST7701_WRITE(st7701, 0xB5, 0x49);
	...
	ST7701_WRITE(st7701, 0xE1, 0x02, 0x8C, 0x00, 0x00, 0x03, 0x8C,
		     0x00, 0x00, 0x00, 0x33, 0x33);
	ST7701_WRITE(st7701, 0xE2, 0x33, 0x33, 0x33, 0x33, 0xC9, 0x3C,
		     0x00, 0x00, 0xCA, 0x3C, 0x00, 0x00, 0x00);
	ST7701_WRITE(st7701, 0xE3, 0x00, 0x00, 0x33, 0x33);
	ST7701_WRITE(st7701, 0xE4, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE5, 0x05, 0xCD, 0x82, 0x82, 0x01, 0xC9,
		     0x82, 0x82, 0x07, 0xCF, 0x82, 0x82, 0x03, 0xCB,
		     0x82, 0x82);
	ST7701_WRITE(st7701, 0xE6, 0x00, 0x00, 0x33, 0x33);
	ST7701_WRITE(st7701, 0xE7, 0x44, 0x44);
	ST7701_WRITE(st7701, 0xE8, 0x06, 0xCE, 0x82, 0x82, 0x02, 0xCA,
		     0x82, 0x82, 0x08, 0xD0, 0x82, 0x82, 0x04, 0xCC,
		     0x82, 0x82);
	ST7701_WRITE(st7701, 0xEB, 0x08, 0x01, 0xE4, 0xE4, 0x88, 0x00, 0x40);
	ST7701_WRITE(st7701, 0xEC, 0x00, 0x00, 0x00);
	ST7701_WRITE(st7701, 0xED, 0xFF, 0xF0, 0x07, 0x65, 0x4F, 0xFC,
		     0xC2, 0x2F, 0xF2, 0x2C, 0xCF, 0xF4, 0x56, 0x70,
		     0x0F, 0xFF);
	...
	msleep(20);
	ST7701_WRITE(st7701, 0x13);

	dev_info(st7701->panel.dev, "YX45011ACT2 source-built h400_60hz_c1_0f10_webgip init end\n");
}
...
static int st7701_prepare(struct drm_panel *panel)
{
	...
	if (st7701->desc->raw_init_sequence) {
...
static const struct drm_display_mode yousee_yx45011act2_mode = {
	.clock		= 32412,
...
static const struct st7701_panel_desc yousee_yx45011act2_desc = {
	.mode = &yousee_yx45011act2_mode,
	.lanes = 2,
	.format = MIPI_DSI_FMT_RGB888,
	.panel_sleep_delay = 20,
	.raw_init_sequence = true,
	.gip_sequence = yousee_yx45011act2_sequence,
};
...
static const struct of_device_id st7701_dsi_of_match[] = {
	...
	{ .compatible = "yousee,yx45011act2", .data = &yousee_yx45011act2_desc },
	{ }
};
